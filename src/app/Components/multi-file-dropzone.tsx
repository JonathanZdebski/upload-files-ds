...
const MultiFileDropzone = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const imageDropzoneOptions: DropzoneOptions = {
      ...dropzoneOptions,
      accept: {
        "image/jpeg": [],
        "image/png": [],
